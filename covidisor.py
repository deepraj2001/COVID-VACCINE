...
with  st.beta_expander("Start"):
	if st.checkbox("I have already got myself vaccinated."):
		...
		s1=st.selectbox("1) Age--",["0-2 years old","3-17 years old","18-44 years old","45-60 years old","above 60 years old"])
        
		if s1=="0-2 years old":
			s1='I'
		if s1=="3-17 years old":
			s1='C'
		if s1=="18-44 years old":
			s1='T'
		if s1=="45-60 years old":
			s1='A'
		if s1=="above 60 years old":
			s1='O'
